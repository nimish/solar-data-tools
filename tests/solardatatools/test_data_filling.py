...
@pytest.fixture
def data_filling_test_data(fixtures_dir: Path) -> dict[str, np.ndarray]:
...
def test_zero_nighttime(data_filling_test_data: dict[str, np.ndarray]):
...
def test_interp_missing(data_filling_test_data: dict[str, np.ndarray]):
