...
@pytest.fixture
def tilt_data_files(fixtures_dir: Path) -> dict[str, np.ndarray]:
...
def test_fit_tilt(tilt_data_files: dict[str, np.ndarray]):
    # INPUTS
    ...
    np.testing.assert_almost_equal(actual_output[0], expected_output, decimal=4)
