...
@pytest.fixture
def estimate_latitude_data(fixtures_dir: Path) -> dict[str, npt.NDArray[np.float64]]:
...
def test_estimate_latitude(estimate_latitude_data: dict[str, npt.NDArray[np.float64]]):
