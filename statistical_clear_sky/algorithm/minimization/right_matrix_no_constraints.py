...
class RightMatrixModifiedMinimization(AbstractMinimization):
    _mu_r: float
    _is_degradation_calculated: bool
    _max_degradation: float
    _min_degradation: float
    """
    ...
    def _term_f3(
        self,
        l_cs_param: cvx.Parameter,
        r_cs_param: cvx.Parameter,
        beta_param: cvx.Parameter,
        component_r0: cvx.Parameter,
    ):
        """
