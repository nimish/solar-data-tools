...
class PlotMixin:
    def plot_lr(self, figsize=(14, 10), show_days=False) -> Figure:
    ...
    def plot_data_matrix(self, figsize=(12, 6), show_days=False, units="kW") -> Figure:
        if show_days:
            use_day = self._obtain_weights_for_plotting() > 1e-1
        else:
            use_day = None
    ...
    def _obtain_weights_for_plotting(self) -> np.ndarray:
        """
