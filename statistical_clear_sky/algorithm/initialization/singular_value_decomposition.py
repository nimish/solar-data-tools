...
class SingularValueDecomposition:
    ...
    def decompose(self, power_signals_d: npt.NDArray[np.float64], rank_k=4):
        """
        Arguments
        ---------
    ...
    @property
    def left_singular_vectors_u(self) -> npt.NDArray[np.float64]:
        return self._left_singular_vectors_u

    @property
    def singular_values_sigma(self) -> npt.NDArray[np.float64]:
        return self._singular_values_sigma

    @property
    def right_singular_vectors_v(self) -> npt.NDArray[np.float64]:
        return self._right_singular_vectors_v

    @property
    def matrix_l0(self) -> npt.NDArray[np.float64]:
        return self._matrix_l0

    @property
    def matrix_r0(self) -> npt.NDArray[np.float64]:
